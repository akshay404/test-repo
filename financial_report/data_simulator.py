...
_TICKER_DATA = {
    ...
    # ── Info. Technology additions ────────────────────────────────────────────
    "AMD":   (38.0, 0.4, 0.2,  +18.5, +5.2,  340),
    "INTC":  (12.0, 2.8, 0.8,   -8.2, -3.1,   95),
    "QCOM":  (18.0, 1.5, 0.6,   +3.1, +0.9,  175),
    "CRM":   (45.0, 2.1, 0.4,   +9.8, +3.2,  280),
    "ADBE":  (38.0, 1.2, 0.3,   -2.4, -0.8,  225),
    # ── Health Care additions ─────────────────────────────────────────────────
    "CVS":   (11.0, 2.8, 1.2,   -3.5, -1.1,   78),
    "MDT":   (17.0, 3.2, 1.1,   +1.5, +0.4,  108),
    "ISRG":  (60.0, 0.1, 0.0,  +11.2, +3.8,  185),
    "TMO":   (32.0, 2.8, 1.0,   +4.8, +1.5,  210),
    "BMY":   (12.0, 3.5, 1.3,   -4.8, -1.5,  125),
    # ── Financials additions ──────────────────────────────────────────────────
    "GS":    (14.0, np.nan, 1.8, +10.2, +2.8, 185),
    "MS":    (16.0, np.nan, 1.6,  +8.5, +2.2, 165),
    "C":     (10.0, np.nan, 1.4,  +6.1, +1.5, 108),
    "WFC":   (13.0, np.nan, 1.2,  +7.2, +2.0, 220),
    "AXP":   (22.0, 0.8,   0.9,  +9.8, +2.5, 185),
    # ── Cons. Discretionary additions ────────────────────────────────────────
    "LOW":   (22.0, 7.8, 3.8,  +2.9, +0.7,  148),
    "TGT":   (16.0, 2.5, 1.3,  -5.1, -1.8,   62),
    "GM":    ( 6.0, 2.1, 1.5,  +4.2, +1.1,   58),
    "F":     ( 7.5, 2.8, 1.8,  -6.8, -2.3,   34),
    "SBUX":  (28.0, 5.2, 2.8,  -3.2, -1.0,   92),
    # ── Communication Svcs additions ─────────────────────────────────────────
    "CHTR":  (52.0, 6.8, 2.2,  -2.8, -0.8,   52),
    "EA":    (32.0, 1.2, 0.4,  +2.1, +0.5,   38),
    "TTWO":  (np.nan, 2.8, 0.8, -1.5, -0.5,  28),
    "IPG":   (12.0, 3.2, 1.5,  -4.2, -1.3,   14),
    "OMC":   (14.0, 2.8, 1.2,  +3.8, +1.1,   22),
    # ── Industrials additions ─────────────────────────────────────────────────
    "MMM":   (16.0, 3.5, 1.8,  +1.5, +0.4,   68),
    "DE":    (22.0, 2.2, 1.1,  +5.8, +1.7,  125),
    "LMT":   (18.0, 3.8, 1.5,  +8.2, +2.5,  145),
    "BA":    (np.nan, 8.5, 2.8, -9.5, -3.2,  115),
    "FDX":   (18.0, 2.8, 1.4,  +3.2, +0.9,   68),
    # ── Consumer Staples additions ────────────────────────────────────────────
    "CL":    (26.0, 2.5, 1.2,  +3.2, +0.9,   60),
    "MDLZ":  (22.0, 3.8, 1.5,  +1.8, +0.5,   78),
    "STZ":   (32.0, 4.5, 2.1,  -2.5, -0.8,   42),
    "PM":    (16.0, np.nan, 2.8, +5.5, +1.8, 168),
    "MO":    (12.0, np.nan, 2.2, +2.8, +0.8,  82),
    # ── Energy additions ──────────────────────────────────────────────────────
    "OXY":   (12.0, 0.6, 0.4,  -0.8, -0.3,   52),
    "PSX":   (12.0, 1.2, 0.6,  +2.5, +0.7,   58),
    "VLO":   (10.0, 0.8, 0.4,  +1.8, +0.5,   52),
    "HAL":   (16.0, 1.8, 0.8,  -3.5, -1.2,   32),
    "DVN":   ( 9.0, 0.5, 0.3,  -4.8, -1.5,   22),
    # ── Utilities additions ───────────────────────────────────────────────────
    "EXC":   (16.0, 5.2, 1.4,  +0.8, +0.2,   48),
    "PCG":   (20.0, 6.8, 1.8,  +1.2, +0.3,   52),
    "AWK":   (32.0, 8.2, 2.0,  +2.5, +0.7,   28),
    "ETR":   (14.0, 5.5, 1.5,  +0.5, +0.1,   22),
    "WEC":   (22.0, 6.2, 1.4,  +1.8, +0.5,   28),
    # ── Real Estate additions ─────────────────────────────────────────────────
    "SPG":   (32.0, 7.5, 1.5,  +5.5, +1.8,   68),
    "ARE":   (55.0, 9.5, 1.5,  +2.1, +0.6,   22),
    "VTR":   (88.0, 8.8, 1.2,  +3.2, +0.9,   18),
    "EQR":   (52.0, 7.2, 1.1,  -1.5, -0.5,   32),
    "AVB":   (48.0, 7.5, 1.0,  +1.2, +0.3,   28),
    # ── Materials additions ───────────────────────────────────────────────────
    "PPG":   (22.0, 2.2, 0.8,  +2.8, +0.8,   38),
    "NUE":   (10.0, 0.8, 0.4,  +4.5, +1.2,   42),
    "VMC":   (28.0, 3.5, 1.2,  +6.2, +1.8,   28),
    "MOS":   (12.0, 1.5, 0.6,  -3.5, -1.2,   12),
    "ALB":   (18.0, 3.8, 1.5,  -8.2, -2.8,    8),
}
